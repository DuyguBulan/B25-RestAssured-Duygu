...
public class SpartanTestsWithParameters extends SpartanTestBase {
   ...
   //  we will make it Dynamic with RestAssured
    ...
    public void test3() {
        ...
        // Response response = given() --> will only run the requested test
        // Response response = given().log().url --> will return the link of the request
        Response response = given().log().all() // will get all the details of the requirements/list of requested info
