...
public class SpartanGetRequests {
    ...
    String url = "http://3.82.205.143:8000";
  ...
  /*
    ...
    public void test2(){
       ...
       // Then status code must be 200 //we can also get status method by using getStatusCode()
        Assertions.assertEquals(200,response.statusCode());

        //verify content type is application json //we can also get content type by using getContentType()
        Assertions.assertEquals("application/json",response.contentType());
